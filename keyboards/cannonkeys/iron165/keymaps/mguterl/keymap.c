...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_UTIL] = LAYOUT_default(
		...
		_______, _______, TG_WIN,  _______, TO_DFLT, _______, _______, _______, _______, _______, _______, _______, _______, KC_DEL,  _______,
		KC_CAPS, _______, KC_VOLD, KC_VOLU, KC_MUTE, TG_GAME, _______, _______, _______, _______, _______, _______, _______, _______, _______,
