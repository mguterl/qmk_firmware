// TODO:
// 1. Additional default layer for colemak
// 2. hyper key for keybindings
// 3. media keys
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT(
		...
		KC_LCTL, KC_LALT, KC_LGUI, KC_SPC, MO(1), KC_SPC, KC_RALT, MO(2), KC_NO, MO(1), KC_RCTL),
	...
	LAYOUT(
		...
		_______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MRWD, KC_MPLY, KC_MFFD, _______,
		_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
		_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______),
};
