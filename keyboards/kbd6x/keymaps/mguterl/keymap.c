...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [QWER] = LAYOUT(
      ...
      KC_LSFT, ALL_T(KC_Z),    KC_X,    KC_C,    KC_V,    KC_B,     KC_N,   KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, MO(HHKB),
      KC_LCTL, KC_LALT, KC_LGUI,                   LT(UTIL, KC_SPC),                 KC_RGUI, KC_RALT, KC_RCTL
      ),
  ...
  [UTIL] = LAYOUT(
      RESET,   TG(GAMING), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
  ...
  [GAMING] = LAYOUT(
      ...
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,     KC_N,   KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, TG(GAMING),
