 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | GRVF | Ctrl | Alt  | GUI  |Lower |SpcUtl|SpcUtl|Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_ortho_4x12(
    ...
    KC_GRVF, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_BSPC, SPC_UTL, RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_UTIL] =  LAYOUT_ortho_4x12( \
    ...
    _______, _______, _______, GO_BACK, GO_FWD,  _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
...
[_LOWER] = LAYOUT_ortho_4x12(
    ...
    KC_CAPS, _______, KC_VOLD, KC_VOLU, KC_MUTE, KC_BRMU, _______, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE,
    _______, _______, KC_MPRV, KC_MNXT, KC_MPLY, KC_BRMD, _______, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
...
[_RAISE] = LAYOUT_ortho_4x12(
    ...
    KC_CAPS, _______, _______, _______, _______, _______, _______, KC_SPLT, KC_MAX,  KC_SPRT, KC_1PAS, _______,
